...
// /playground/issues' own Issues/Findings layout, carried over unfixed
...
// still available, correctly, at /playground/issues — removing the
...
function get(req, res) {
  ...
  res.render('playground/document/view/traditional/page.njk', {
    id: req.params.id,
    documentName,
    version,
